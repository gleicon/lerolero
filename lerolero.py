#!/usr/bin/env python
# -*- coding: iso-8859-1 -*-
# lista de frases: lerolero.html em http://www.geocities.com/padrelevedo/lerolero/lerolero.htm 
#
# para usar com o espeak:
# python lerolero.py | espeak --stdin -w oi.wav -v pt -s100
#
